...
data = pd.read_csv('hC:\Users\Reza Mehboodi\Downloads\Compressed\individual+household+electric+power+consumption', sep=';', parse_dates=[['Date', 'Time']], na_values='?', low_memory=False)
